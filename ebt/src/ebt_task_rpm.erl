...
perform(Target, Dir, Config) ->
    do([error_m ||
        ...
        AppName <- ebt_config:appname_full(Dir),
...
prepare_spec(Dir, Config, Spec) ->
    do([error_m ||
        ...
        RPMBuildDir <- ebt_config:outdir(rpmbuild, Config),
        Template <- prepare_generic_spec(Dir, Config, Spec, Version),
        AppName <- ebt_config:appname_full(Dir),
        SpecFile <- spec_file(Config, AppName),
...
prepare_generic_spec(Dir, Config, Spec, Version) ->
    do([error_m ||
        ...
        Header <- header(Dir, Config, Spec, Version),
...
header(Dir, Config, Spec, Version) ->
    do([error_m ||
